...
namespace AcheruFriends.Pages
{
    public partial class AddMyFriendComponent : ComponentBase
    {
        ...
        protected async System.Threading.Tasks.Task Load()
        {
            ...
            myfriend = new AcheruFriends.Models.ConData.MyFriend(){};
        }
        ...
        protected async System.Threading.Tasks.Task Form0Submit(AcheruFriends.Models.ConData.MyFriend args)
        {
            try
            {
                var conDataCreateMyFriendResult = await ConData.CreateMyFriend(myFriend:myfriend);
                DialogService.Close(myfriend);
            }
            catch (System.Exception conDataCreateMyFriendException)
            {
                NotificationService.Notify(new NotificationMessage(){ Severity = NotificationSeverity.Error,Summary = $"Error",Detail = $"Unable to create new MyFriend!" });
            }
        }
