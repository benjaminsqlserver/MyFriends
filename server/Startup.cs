...
using AcheruFriends.Authentication;
...
namespace AcheruFriends
{
    public partial class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AcheruFriends.Data.ConDataContext>(options =>
            {
              options.UseSqlServer(Configuration.GetConnectionString("ConDataConnection"));
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, ApplicationIdentityDbContext identityDbContext)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                oDataBuilder.EntitySet<AcheruFriends.Models.ConData.Gender>("Genders");
                oDataBuilder.EntitySet<AcheruFriends.Models.ConData.MyFriend>("MyFriends");
